...
public static class MissionCatalog
{
	...
	{
		new MissionDefinition("coins_10", "Muenzen I", "Sammle insgesamt 10 Muenzen.", MissionStat.TotalCoinsCollected, 10),
		new MissionDefinition("coins_25", "Muenzen II", "Sammle insgesamt 25 Muenzen.", MissionStat.TotalCoinsCollected, 25),
		new MissionDefinition("coins_50", "Muenzen III", "Sammle insgesamt 50 Muenzen.", MissionStat.TotalCoinsCollected, 50),
		new MissionDefinition("coins_100", "Muenzen IV", "Sammle insgesamt 100 Muenzen.", MissionStat.TotalCoinsCollected, 100),
		new MissionDefinition("coins_250", "Muenzen V", "Sammle insgesamt 250 Muenzen.", MissionStat.TotalCoinsCollected, 250),
		...
		new MissionDefinition("survive_30", "Atem holen", "Ueberlebe 30 Sekunden.", MissionStat.BestSurvivalSeconds, 30, true),
		new MissionDefinition("survive_60", "Ruhiger Schwimmer", "Ueberlebe 60 Sekunden.", MissionStat.BestSurvivalSeconds, 60, true),
		new MissionDefinition("survive_120", "Tiefseetour", "Ueberlebe 120 Sekunden.", MissionStat.BestSurvivalSeconds, 120, true),
		new MissionDefinition("survive_180", "Langer Lauf", "Ueberlebe 180 Sekunden.", MissionStat.BestSurvivalSeconds, 180, true),
		...
		new MissionDefinition("trash_1", "Aua Tempo", "Sammle einmal Muell ein.", MissionStat.LifetimeTrashCollected, 1),
